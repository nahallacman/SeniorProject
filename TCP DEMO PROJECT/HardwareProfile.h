...
//	
//    #if defined( ZG2100_IN_SPI1 ) && !defined(__32MX460F512L__) && !defined(__32MX795F512L__)
//        // ZG2100 in SPI1 slot
...
//        #endif
//        
//    #elif defined( ZG2100_IN_SPI2 ) && !defined(__32MX460F512L__) && !defined(__32MX795F512L__)
//        // ZG2100 in SPI2 slot
...
//        #endif
//
//	#elif defined( ZG2100_IN_SPI1 ) && (defined(__32MX460F512L__) || defined(__32MX795F512L__))
//        // ZG2100 in SPI1 slot
...
// PIC32 Ethernet Starter Kit (04-02146) with PIC32MX795F512L processor and National DP83848 10/100 PHY
	...
	#define LED_GET()			(*((volatile unsigned char*)(&LATD)) & 0x0F)
	#define LED_PUT(a)			(*((volatile unsigned char*)(&LATD)) = \
								 (*((volatile unsigned char*)(&LATD)) & ~0x0F) | (a & 0x0F))
...
//	#define putrsUART(a)			putrsUART2(a)
	...
	#define UART_MODULE_USED		UART1
	#define UARTTX_TRIS 			TRISFbits.TRISF8
	#define UARTRX_TRIS 			TRISFbits.TRISF2
	#define BusyUART()				( !UARTTransmitterIsReady(UART_MODULE_USED) )

	#define CloseUART()				UARTEnable(UART_MODULE_USED, UART_DISABLE)
//	#define ConfigIntUART(a)		ConfigIntUART1(a)
	#define DataRdyUART()			( UARTGetLineStatus(UART_MODULE_USED) == UART_DATA_READY )
	#define OpenUART(baud)			do{ UARTConfigure(UART_MODULE_USED, UART_ENABLE_PINS_TX_RX_ONLY); \
										UARTSetLineControl(UART_MODULE_USED, UART_DATA_SIZE_8_BITS | UART_PARITY_NONE | UART_STOP_BITS_1); \
										UARTSetDataRate(UART_MODULE_USED, GetPeripheralClock(), baud); \
    									UARTEnable(UART_MODULE_USED, UART_ENABLE_FLAGS(UART_PERIPHERAL | UART_RX | UART_TX)); \
									} while(0)
	#define ReadUART()				UARTGetDataByte(UART_MODULE_USED)
	#define WriteUART(a)			UARTSendDataByte(UART_MODULE_USED, a)
//	#define getsUART(a,b,c)			getsUART1(a,b,c)
	#define putsUART(a)				do{ BYTE *p = a; while(*p) {while(BusyUART()); WriteUART(*p++);} while(BusyUART()); }while(0)
