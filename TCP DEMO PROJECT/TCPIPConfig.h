...
#define MY_DEFAULT_MAC_BYTE4            (0x56)	// and wish to use the internal
#define MY_DEFAULT_MAC_BYTE5            (0x43)	// factory programmed MAC
#define MY_DEFAULT_MAC_BYTE6            (0x21)	// address instead.

#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (0ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (113ul)
 ...
 */
	...
	#define TCP_PIC_RAM_SIZE					(12145ul)
