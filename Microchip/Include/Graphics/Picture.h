...
*
********************************************************************/
    #define PictSetBitmap(pPict, pBtmap)    ((PICTURE*)pPict)->pBitmap = (IMAGE_FLASH*) pBtmap
...
PICTURE * PictCreate
    (
        WORD ID, SHORT left, SHORT top, SHORT right, SHORT bottom, WORD state, char scale, const IMAGE_FLASH *pBitmap, GOL_SCHEME *
        pScheme
    );
